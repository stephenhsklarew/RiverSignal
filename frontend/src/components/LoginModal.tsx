...
export default function LoginModal({ onClose, dark, mode = 'signup' }: LoginModalProps) {
    ...
    <div className={`login-overlay ${dark ? 'dark' : ''}`} onClick={onClose}>
      <div className="login-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="login-header">
          ...
          <p>{isSignUp
            ? 'Create an account to save observations, save settings, and sync across devices'
