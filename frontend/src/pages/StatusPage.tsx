...
const SOURCE_META: Record<string, { description: string; upstream: string; refresh: string; license?: string; commercial?: boolean }> = {
  ...
  massachusetts: { description: 'Massachusetts state data — MassWildlife trout stocking, MA DMF river-herring counts (Ipswich River MA)', upstream: 'Weekly', refresh: 'Weekly', license: 'Public Records (MGL c.66)', commercial: true },
...
const BRONZE_DESCRIPTIONS: Record<string, string> = {
  ...
  rockhounding_sites: 'Rockhounding locations across covered watersheds — thundereggs, agates, obsidian, sunstone, opal, petrified wood',
  river_stories: 'Pre-cached AI-generated ecological narratives at 3 reading levels per watershed',
  stocking_locations: 'Fish stocking/planting releases by state agency, species, and date',
  utah_impaired_waters: 'Utah DEQ 303(d) listed impaired stream segments',
